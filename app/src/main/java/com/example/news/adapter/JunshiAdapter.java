...
public class JunshiAdapter extends BaseAdapter {
    private Context context;

    private List<Junshi.BAI67OGGwangningBean> dataList;

    private LayoutInflater inflater;

    private BitmapUtils bitmapUtils;

    public JunshiAdapter(Context context, List<Junshi.BAI67OGGwangningBean> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        Junshi.BAI67OGGwangningBean result = dataList.get(position);
