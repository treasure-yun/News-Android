...
public class ENTAdapter extends BaseAdapter {
    ...
    private List<ENT.T1348648517839Bean> dataList;

    private LayoutInflater inflater;

    private BitmapUtils bitmapUtils;

    public ENTAdapter(Context context, List<ENT.T1348648517839Bean> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ENT.T1348648517839Bean result = dataList.get(position);
