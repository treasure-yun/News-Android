...
public class TtAdapter extends BaseAdapter {
    ...
    private List<Toutiao.T1348647853363Bean> dataList;

    private LayoutInflater inflater;

    private BitmapUtils bitmapUtils;

    public TtAdapter(Context context, List<Toutiao.T1348647853363Bean> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        Toutiao.T1348647853363Bean result = dataList.get(position);
