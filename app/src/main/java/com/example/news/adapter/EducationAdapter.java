...
public class EducationAdapter extends BaseAdapter {
    ...
    private List<Education.BA8FF5PRwangningBean> dataList;

    private LayoutInflater inflater;

    private BitmapUtils bitmapUtils;

    public EducationAdapter(Context context, List<Education.BA8FF5PRwangningBean> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        Education.BA8FF5PRwangningBean result = dataList.get(position);
