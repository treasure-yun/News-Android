...
public class PhoneAdapter extends BaseAdapter {
    ...
    private List<Phone.BAI6I0O5wangningBean> dataList;

    private LayoutInflater inflater;

    private BitmapUtils bitmapUtils;

    public PhoneAdapter(Context context, List<Phone.BAI6I0O5wangningBean> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        Phone.BAI6I0O5wangningBean result = dataList.get(position);
